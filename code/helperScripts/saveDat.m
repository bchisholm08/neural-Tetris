...
% get subj directory paths from the params 
...
if demoMode
    ...
    % in real exp save behavioral .csv and params .mat 
else
    ...
    % save params and stim seq to .mat 
    % build filename, e.g., P01_p4_params_16Jun2025.mat
