...
function p5instruct(window, expParams)
    ...
    txt1 = sprintf(['Final Part of the Human Tetris Experiment\n\n' ...
        ...
        'remain the same! \n\n' ...
        'You will be allowed to play games of Tetris for FIXME PRINT MIN. Score as many points as possible! \n\nPress `SPACE` to proceed...\n']); % games allowed will eventually be time controlled 
...
% screen 2 
txt2 = sprintf(['This section is nearly identical to ''regular'' Tetris.\n\n' ...
    ...
    'The `DOWN ARROW`   ↓  will move a piece down faster, but not immediately']);
