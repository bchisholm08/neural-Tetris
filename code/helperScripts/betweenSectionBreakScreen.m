...
% the block break screen. interExpScreen displays a break screen with a timer.
% Uses the existing PTB window and expParams for timing and colors.
%
%-------------------------------------------------------
...
breakStartTime = GetSecs;

KbName('UnifyKeyNames');
spaceKey = KbName('SPACE');

while (GetSecs - breakStartTime) < maxBreakTime
    elapsed = GetSecs - breakStartTime;
    ...
    % this while loop needs to call checkForPause 
